...
export const eksistere = {
    ...
    FileReferences: {
        ...
        Motions: {
            Idle: [
                { File: "motions/Mgirl12_stand.motion3.json" },
                { File: "motions/Mgirl12_stand_c.motion3.json" },
                { File: "motions/Mgirl12_stand_a.motion3.json" },
                { File: "motions/Mgirl12_stand.motion3.json" },
                { File: "motions/Mgirl12_stand02.motion3.json" },
            ],
        },
    },
...
export function setupENV() {
    ...
    TEST_MODEL4.modelData = readArrayBuffer(
        urlResolve(TEST_MODEL4.file, TEST_MODEL4.json.FileReferences.Moc),
    );
